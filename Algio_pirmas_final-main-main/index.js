...
// TEXT TRANSLATION CODE----------------
     ...
     updateElementContent('aboutIdh1', language === 'LT' ? "Apie mus" 
     : "About us");

     updateElementContent('aboutIdStart', language === 'LT' ? "Kaip mes pradėjome" 
     : "How we started");

     updateElementContent('aboutIdStartContent', language === 'LT' ? "Kaip mes pradejome: Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ratione excepturi quidem dolorum ducimus nemo eligendi, culpa sapiente blanditiis quasi non, illo commodi? Iure eum, et debitis quasi eveniet temporibus" 
     ...
     updateElementContent('aboutIdHistory', language === 'LT' ? "Istorija" 
     : "History");

     updateElementContent('aboutIdHistoryContent', language === 'LT' ? "Istorija: Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ratione excepturi quidem dolorum ducimus nemo eligendi, culpa sapiente blanditiis quasi non, illo commodi? Iure eum, et debitis quasi eveniet temporibus voluptatum dolorum. Perspiciatis, voluptas! Dignissimos facilis perspiciatis iste, illum esse possimus deserunt porro laboriosam omnis quisquam ipsa incidunt error commodi eum ab quas praesentium tempore soluta labore amet veniam quam est nulla. Natus laborum nemo ad odio, eos facere veritatis, non dicta commodi in, harum sed!" 
     : "History: Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ratione excepturi quidem dolorum ducimus nemo eligendi, culpa sapiente blanditiis quasi non, illo commodi? Iure eum, et debitis quasi eveniet temporibus voluptatum dolorum. Perspiciatis, voluptas! Dignissimos facilis perspiciatis iste, illum esse possimus deserunt porro laboriosam omnis quisquam ipsa incidunt error commodi eum ab quas praesentium tempore soluta labore amet veniam quam est nulla. Natus laborum nemo ad odio, eos facere veritatis, non dicta commodi in, harum sed!");

     updateElementContent('aboutIdVision', language === 'LT' ? "Mūsų siekiai" 
     : "Our goals");

     updateElementContent('aboutIdVisionContent', language === 'LT' ? "Musu siekiai: Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ratione excepturi quidem dolorum ducimus nemo eligendi, culpa sapiente blanditiis quasi non, illo commodi? Iure eum, et debitis quasi eveniet temporibus voluptatum dolorum. Perspiciatis, voluptas! Dignissimos facilis perspiciatis iste, illum esse possimus deserunt porro laboriosam omnis quisquam ipsa incidunt error commodi eum ab quas praesentium tempore soluta" 
     : "Our goals: Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ratione excepturi quidem dolorum ducimus nemo eligendi, culpa sapiente blanditiis quasi non, illo commodi? Iure eum, et debitis quasi eveniet temporibus voluptatum dolorum. Perspiciatis, voluptas! Dignissimos facilis perspiciatis iste, illum esse possimus deserunt porro laboriosam omnis quisquam ipsa incidunt error commodi eum ab quas praesentium tempore soluta");

     updateElementContent('aboutIdFeedback', language === 'LT' ? "Puikus palaikymas ir protinga kaina" 
     : "Superior service at reasonable costs");

     updateElementContent('aboutIdFeedbackAuthor', language === 'LT' ? "Laimingas užsakovas" 
     : "Happy customer");

     ///PRODUCTS MIDDLE SECTION LT-------------------
     updateElementContent('productsIdh2', language === 'LT' ? "PRODUKTAI, KURIUOS SIŪLOME" 
    : "PRODCTS WE OFFER");       
    // updateElementContent('', "");

    ///SERVICES MIDDLE SECTION LT -----------
    updateElementContent('serviceIdh1', language === 'LT' ? "PASLAUGOS, KURIAS MES SIŪLOME" : "SERVICES WE OFFER");   
    updateElementContent('serviceIdFirst', language === 'LT' ? "FIZINIAMS ASMENIMS" : "PRIVATE CUSTOMERS");   
    updateElementContent('serviceIdli1', language === 'LT' ? "Siūlome" : "Offers");   
    updateElementContent('serviceIdli2', language === 'LT' ? "Parduodame" : "Sells");   
    updateElementContent('serviceIdli3', language === 'LT' ? "Prižiūrime" : "Maintain");   
    updateElementContent('serviceIdli4', language === 'LT' ? "Nuomojame" : "Rents");   
    updateElementContent('serviceIdSecond', language === 'LT' ? "JURIDINIAMS ASMENIMS" : "SERVICE WE OFFER");   
    updateElementContent('serviceIdli_1', language === 'LT' ? "Siūlome" : "Offers");   
    updateElementContent('serviceIdli_2', language === 'LT' ? "Parduodame" : "Sells");   
    updateElementContent('serviceIdli_3', language === 'LT' ? "Prižiūrime" : "Maintain");     
    updateElementContent('serviceIdli_4', language === 'LT' ? "Nuomojame" : "Rents");   
    
    ///PARTNERS MIDDLE SECTION LT -----------
    updateElementContent('partnersIdh2', language === 'LT' ? "INFORMACIJA PARTNERIAMS" : "INFO FOR PARTNERS"); 
    updateElementContent('partnersIdh3', language === 'LT' ? "Jau greitai" : "Comming soon"); 
    ...
    function updateDropdownContent(language) {
        ...
        if (dropdownButton && dropdownContent) {
            ...
            dropdownContent.innerHTML = language === 'LT' ? "<a href='#'>EN</a>" : "<a href='#'>LT</a>";
        }
    }
